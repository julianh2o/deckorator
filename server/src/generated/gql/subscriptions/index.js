...
module.exports.DeckCard_stream = fs.readFileSync(path.join(__dirname, 'DeckCard_stream.gql'), 'utf8');
...
module.exports.DeckTemplateCard_stream = fs.readFileSync(path.join(__dirname, 'DeckTemplateCard_stream.gql'), 'utf8');
...
module.exports.DeckTemplate_stream = fs.readFileSync(path.join(__dirname, 'DeckTemplate_stream.gql'), 'utf8');
...
module.exports.Deck_stream = fs.readFileSync(path.join(__dirname, 'Deck_stream.gql'), 'utf8');
...
module.exports.GeneratedImage_stream = fs.readFileSync(path.join(__dirname, 'GeneratedImage_stream.gql'), 'utf8');
...
module.exports.Generation_stream = fs.readFileSync(path.join(__dirname, 'Generation_stream.gql'), 'utf8');
